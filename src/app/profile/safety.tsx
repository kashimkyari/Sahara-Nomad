    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.trustBanner}>
          <ShieldCheck size={28} color={DT.colors.secondary} strokeWidth={2.5} />
        ...
        {rules.map((rule, i) => (
          ...
          >
            <View style={styles.accordionHeader}>
              ...
              {expanded === i
                ? <ChevronUp size={18} color={DT.colors.text} strokeWidth={2.5} />
                : <ChevronDown size={18} color={DT.colors.text} strokeWidth={2.5} />}
            </View>
            {expanded === i && (
...
const styles = StyleSheet.create({
  ...
  trustBanner: {
    ...
    backgroundColor: DT.colors.surface, borderWidth: 2, borderColor: DT.colors.secondary,
  ...
  trustText: { flex: 1 },
  trustTitle: { fontFamily: DT.typography.heading, fontSize: 15, color: DT.colors.text },
  trustSub: { fontFamily: DT.typography.body, fontSize: 12, color: DT.colors.muted, marginTop: 3, lineHeight: 18 },
  scoreRow: {
    flexDirection: 'row', justifyContent: 'space-between', marginBottom: DT.spacing.lg,
    backgroundColor: DT.colors.surface, borderWidth: 2, borderColor: DT.colors.text,
    shadowColor: DT.colors.text, shadowOffset: { width: 3, height: 3 }, shadowOpacity: 1, shadowRadius: 0, elevation: 3,
  },
  ...
  scoreCheckActive: { backgroundColor: DT.colors.secondary },
  scoreCheckMark: { fontFamily: DT.typography.heading, fontSize: 14, color: DT.colors.surface },
  scoreLabel: { fontFamily: DT.typography.body, fontSize: 11, color: DT.colors.muted, textAlign: 'center' as const },
  sectionLabel: {
  ...
  accordionOpen: { borderColor: DT.colors.primary },
  accordionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  accordionTitle: { fontFamily: DT.typography.heading, fontSize: 14, color: DT.colors.text, flex: 1, marginRight: DT.spacing.sm },
  accordionBody: {
