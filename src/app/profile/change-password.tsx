...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  inputWrap: { gap: 6 },
  inputLabel: {
    fontFamily: DT.typography.heading, fontSize: 11, color: colors.muted, letterSpacing: 1.5,
  },
  inputRow: {
  ...
  textInput: {
    ...
    fontFamily: DT.typography.body, fontSize: 16, color: colors.text, letterSpacing: 3,
  },
  eyeBtn: {
  ...
  ruleText: { fontFamily: DT.typography.body, fontSize: 13, color: colors.muted },
  ruleTextMet: { color: colors.secondary },
  saveBtn: {
