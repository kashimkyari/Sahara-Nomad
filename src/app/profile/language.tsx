...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  saveBtnText: { fontFamily: DT.typography.heading, fontSize: 13, color: colors.surface },
  ...
  langLabel: { flex: 1, fontFamily: DT.typography.body, fontSize: 15, color: colors.text },
  langLabelActive: { fontFamily: DT.typography.bodySemiBold, color: colors.primary },
  checkBox: {
    width: 24, height: 24, backgroundColor: colors.primary, borderWidth: 2,
    borderColor: colors.text, alignItems: 'center', justifyContent: 'center',
  },
  divider: { height: 2, backgroundColor: colors.text },
  noteBox: {
    marginTop: DT.spacing.md, borderWidth: 2, borderColor: colors.accent,
    backgroundColor: colors.accent + '15', padding: DT.spacing.md,
  },
  noteText: {
    fontFamily: DT.typography.body, fontSize: 13, color: colors.text, lineHeight: 20,
  },
  regionHint: {
  ...
  regionText: { fontFamily: DT.typography.bodySemiBold, fontSize: 14, color: colors.text },
  regionTextActive: { color: colors.surface },
  applyBtn: {
  ...
  applyBtnText: { fontFamily: DT.typography.heading, fontSize: 17, color: colors.surface },
});
